...
A dedicated crawler agent for accessing public manga data from `mangafire.to`. Built on `KamiYomu.CrawlerAgents.Core`, this agent enables efficient search, metadata extraction, and integration with the KamiYomu platform.

## Features
- Search public `mangafire.to` content (titles, authors, tags)
...
The package is published as `KamiYomu.CrawlerAgents.MangaFire`.
...
- Navigate to `/src/KamiYomu.CrawlerAgents.MangaFire/`
- Double-click `KamiYomu.CrawlerAgents.MangaFire.sln`
...
- VS Code: Terminal > `dotnet build src/KamiYomu.CrawlerAgents.MangaFire/KamiYomu.CrawlerAgents.MangaFire.sln`
